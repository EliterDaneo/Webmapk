      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="<?= base_url('guru/notif')?>"><small><?= $page ;?></small></a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-body">
          ...
          <div class="card-footer justify-content-between">
            <a class="btn btn-secondary btn-sm" href="<?= base_url('guru');?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a class="btn btn-danger btn-sm" href="<?= base_url('guru/deleteNotif/').$this->encrypt->encode($notif->id_request).'';?>"><i class="fas fa-trash"></i>&ensp;Delete</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
